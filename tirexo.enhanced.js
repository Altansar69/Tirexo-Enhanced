...
// @contact  https://cs.rin.ru/forum/memberlist.php?mode=viewprofile&u=1280185
// ==/UserScript==
...
function redirectOldSite() {
    if (options.redirect_old_site) {
        if(document.location.hostname.search("tirexo.ai")==0) { //when you are in old address
            document.location.hostname="www2.tirexo.work"; //redirect to the latest
        }
    }
}
